...
para('이용수수료율은 하위 계층으로 갈수록 높아지는 구조입니다. 각 계층은 자신의 상위 계층보다 낮은 요율로 설정할 수 없으며, 회원에게 실제 적용되는 요율은 매장(Store)의 이용수수료율입니다. 구매 확인 시 각 계층의 마진(내 하위 계층 요율 − 내 요율)에 해당하는 금액이 자동 배분됩니다.');
...
const nodes = [
  ...
  { label: '회원 적용', val: '3.0%', color: '#7c3aed', tc: WHITE },
];
...
h4('마진 배분 예시 (구매금액 100,000원, 입금수수료 500원, 매장 이용수수료율 3%)');
table(
  ['계층', '설정 요율', '마진율', '배분 금액'],
  [
    ['매장', '3.0%', '3.0% − 2.0% = 1.0%', '100,000 × 1.0% = 1,000원 → 매장 잔액 직접 미적용 (수수료로 차감됨)'],
    ['대리점', '2.0%', '3.0% − 2.0% = 1.0%', '100,000 × 1.0% = 1,000원 수익 자동 배분'],
    ['총판', '1.5%', '2.0% − 1.5% = 0.5%', '100,000 × 0.5% = 500원 수익 자동 배분'],
    ['본사', '1.0%', '1.5% − 1.0% = 0.5%', '100,000 × 0.5% = 500원 수익 자동 배분'],
    ['(최상위)', '—', '1.0% 잔여', '100,000 × 1.0% = 1,000원 최상위 노드 귀속'],
  ],
  [60, 80, 130, 225]
);
infoBox('ℹ️ 계산식: 매장 적립액 = 구매금액 − 입금수수료 − (구매금액 × 매장 이용수수료율)\n예) 100,000원 − 500원(입금수수료) − 3,000원(이용수수료 3%) = 96,500원 매장 잔액 적립\n\n하위 계층 요율은 상위보다 낮게 설정 불가. 차이(마진)가 각 계층의 수수료 수익으로 자동 배분됩니다.');
